...
enum TypeType { Type_Quat, Type_Vec, Type_Pose, Type_IMU, Type_CloneIMU, Type_Landmark, Type_UNKNOWN };
...
public:
   ...
   */
  virtual void update(const Eigen::VectorXd &dx, bool do_tekf = false) = 0;
...
protected:
  ...
  TypeType _type = TypeType::Type_UNKNOWN;
