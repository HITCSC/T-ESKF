...
public:
  ...
  /**
   * @brief Performs TEKF propagation of the state covariance.
   *
   *
   ...
   */
  static void TEKFPropagation(std::shared_ptr<State> state, const Eigen::Vector3d &p0, const Eigen::Vector3d &v0,  const Eigen::MatrixXd &Phi, const Eigen::MatrixXd &Q);
